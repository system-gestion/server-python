...
from app.routes import auth, clientes, pedidos, usuarios, articulos, auditoria, comisiones, storage, ofertas, ws_users, ws_clientes
...
app.include_router(ws_clientes.router)
